...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx7cc85fb4f361ce80',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'ce51ed2583dad3097559c6e7cb1a4557',
  ...
  USERS: [
    {
      ...
      id: 'osP5X6-snZY-eqjxrnhkbYPyINUc',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '8MFPY-QWRxMxnScY_93UK62OwtshcHbp6esjIFP7VwE',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '焦作',
    ...
    },
     {
      ...
      name: 'H',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'osP5X69R3XPI-3m88ho9gC2gnZAI',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '8MFPY-QWRxMxnScY_93UK62OwtshcHbp6esjIFP7VwE',
      // 所在省份
      province: '河南',
